...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	СформироватьДвиженияГрафикОтпусков();
...
Процедура СформироватьДвиженияГрафикОтпусков()
	...
	Запрос.Текст = 
		"ВЫБРАТЬ
		|	ВКМ_ОсновныеНачисленияДанныеГрафика.Сотрудник КАК Сотрудник,
		|	ВКМ_ОсновныеНачисленияДанныеГрафика.ЗначениеФактическийПериодДействия КАК КоличествоИспользованныхДнейОтпуска,
	...
	Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
		...
		Движение.Период = Дата;
		Движение.Год = ВыборкаДетальныеЗаписи.Год;
		Движение.Сотрудник = ВыборкаДетальныеЗаписи.Сотрудник;
		Движение.КоличествоДней = ВыборкаДетальныеЗаписи.КоличествоИспользованныхДнейОтпуска;
